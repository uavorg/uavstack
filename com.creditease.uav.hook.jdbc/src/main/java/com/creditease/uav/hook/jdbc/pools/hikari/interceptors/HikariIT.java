...
package com.creditease.uav.hook.jdbc.pools.hikari.interceptors;
...
public class HikariIT {

    public HikariIT(String proxyId, Object ds) {
        ...
        proxyId = "com.creditease.uav.hook.jdbc.pools.hikari.HikariHookProxy@" + proxyId;
