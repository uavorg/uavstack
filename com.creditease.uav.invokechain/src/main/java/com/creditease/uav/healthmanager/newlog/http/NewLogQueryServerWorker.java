...
public class NewLogQueryServerWorker extends AbstractHttpServiceComponent<UAVHttpMessage> {

    public NewLogQueryServerWorker(String cName, String feature, String initHandlerKey) {
    ...
    protected void adaptResponse(HttpMessage message, UAVHttpMessage t) {
        ...
        if (log.isDebugEnable()) {
            log.debug(this, "NewLogQueryServerWorker Response: " + response);
        }
    }
}
