...
import com.creditease.uav.invokechain.data.JdbcSlowOperSpan;
 ...
 *
 */
public class SlowOperJdbcAction extends AbstractSlowOperProtocolAction {

    public SlowOperJdbcAction(String cName, String feature, IActionEngine engine) {
    ...
    public void doAction(ActionContext context) throws Exception {
        ...
        JdbcSlowOperSpan span = new JdbcSlowOperSpan(msg.get(0), msg.get(1), msg.get(2),
                (String) context.getParam("appid"), msg.get(3), msg.get(4));
