...
public class InvokeChainQueryServerWorker extends AbstractHttpServiceComponent<UAVHttpMessage> {

    public InvokeChainQueryServerWorker(String cName, String feature, String initHandlerKey) {
    ...
    protected void adaptResponse(HttpMessage message, UAVHttpMessage t) {
        ...
        if (log.isDebugEnable()) {
            log.debug(this, "InvokeChainQueryServerWorker Response: " + response);
        }
    }
