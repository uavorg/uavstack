...
public class JMXMSCPMonitorDataCatchWorker extends JMXAppServerMonitorDataCatchWorker {

    public JMXMSCPMonitorDataCatchWorker(String cName, String feature, JVMAgentInfo appServerInfo,
