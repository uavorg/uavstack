...
package com.creditease.uav.hook.esclient.transport.invokeChain;
...
public  class TransportAdapter extends InvokeChainAdapter{
    ...
    public void beforePreCap(InvokeChainContext context, Object[] args) {
        ...
        context.put(InvokeChainConstants.CLIENT_IT_KEY,
                DataConvertHelper.toInt(System.getProperty("com.creditease.uav.invokechain.code.es.key"), 0));
        context.put(InvokeChainConstants.CLIENT_IT_CLASS,
                System.getProperty("com.creditease.uav.invokechain.code.es.class"));
    }
