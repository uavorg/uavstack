...
public class Log4jTest extends HttpServlet {
    ...
    org.apache.log4j.Logger log4j = org.apache.log4j.Logger.getLogger("logger1");
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        else if (type.equals("newlog_test")) {

            for (int i = 0; i < 10; i++) {
                this.log4j.info("this is a test log message. 中文测试，测试中文");
            }
        }
