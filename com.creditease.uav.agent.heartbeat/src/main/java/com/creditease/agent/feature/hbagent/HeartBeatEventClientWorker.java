...
public class HeartBeatEventClientWorker
        extends AbstractHandleWorkComponent<HeartBeatEvent, AbstractHandler<HeartBeatEvent>> {

    public HeartBeatEventClientWorker(String cName, String feature, String initHandlerKey) {
