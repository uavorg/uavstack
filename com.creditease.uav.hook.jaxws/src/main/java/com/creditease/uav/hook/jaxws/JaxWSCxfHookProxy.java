...
import com.creditease.uav.hook.jaxws.interceptors.JaxWSCxfHookIT;
...
public class JaxWSCxfHookProxy extends HookProxy {
    ...
    public JaxWSCxfHookProxy(String id, Map config) {
    ...
    public void doInstallDProxy(ClassLoader webapploader, final String appid) {
        ...
        /**
         * install proxy to ClientProxyFactoryBean
         */
        dpInstall.installProxy("org.apache.cxf.frontend.ClientProxyFactoryBean", new String[] { "com.creditease.uav.hook.jaxws.interceptors" },
                new DynamicProxyProcessor() {
                    ...
                    public void process(DPMethod m) throws Exception {
                        ...
                        if ("create".equals(m.getName())) {
                            ...
                            m.insertAfter("{$_=mObj.create($_,this.clientFactoryBean);}");
