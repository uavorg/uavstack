...
public class HttpAsyncClientFactory {
    ...
    public static HttpAsyncClient build(int maxConnectionPerRoute, int maxTotalConnection, int sockTimeout,
            int connectTimeout, int requestTimeout) {

        HttpAsyncClient client = new HttpAsyncClient(maxConnectionPerRoute, maxTotalConnection, sockTimeout,
