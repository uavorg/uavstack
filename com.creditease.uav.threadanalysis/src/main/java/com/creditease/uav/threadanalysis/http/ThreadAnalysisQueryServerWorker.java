...
public class ThreadAnalysisQueryServerWorker extends AbstractHttpServiceComponent<UAVHttpMessage> {

    public ThreadAnalysisQueryServerWorker(String cName, String feature, String initHandlerKey) {
    ...
    protected void adaptResponse(HttpMessage message, UAVHttpMessage t) {
        ...
        if (log.isDebugEnable()) {
            log.debug(this, "ThreadAnalysisQueryServerWorker Response: " + response);
        }
    }
