...
package com.creditease.uav.feature.apphubmanager;
...
public class AppHubManagerServerWorker extends AbstractHttpServiceComponent<UAVHttpMessage> {

    public AppHubManagerServerWorker(String cName, String feature, String initHandlerKey) {
    ...
    protected void adaptResponse(HttpMessage message, UAVHttpMessage t) {
        ...
        if (log.isDebugEnable()) {
            log.debug(this, "AppHubMangerServerWorker Response: " + response);
        }
