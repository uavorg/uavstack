...
public class RuntimeNotifyServerWorker extends AbstractHttpServiceComponent<UAVHttpMessage> {

    public RuntimeNotifyServerWorker(String cName, String feature, String initHandlerKey) {
    ...
    protected void adaptResponse(HttpMessage message, UAVHttpMessage t) {
        ...
        if (log.isDebugEnable()) {
            log.debug(this, "RuntimeNotifyServerWorker Response: " + response);
        }
    }
