...
/**
 * ServerExprAdaptor description: for SERVER_RESP expr's adaption
 *
 */
public class ServerExprAdaptor extends AbstractExprAdaptor{


    public ServerExprAdaptor(String cName, String feature, IActionEngine engine) {
