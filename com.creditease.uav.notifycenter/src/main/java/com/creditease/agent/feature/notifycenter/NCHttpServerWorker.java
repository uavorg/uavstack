...
public class NCHttpServerWorker extends AbstractHttpServiceComponent<UAVHttpMessage> {

    public NCHttpServerWorker(String cName, String feature, String initHandlerKey) {
    ...
    protected void adaptResponse(HttpMessage message, UAVHttpMessage t) {
        ...
        if (log.isDebugEnable()) {
            log.debug(this, "NCHttpServerWorker Response: " + response);
        }
    }
