...
public class RuleFilterFactory {
    ...
    private final LogFilterAndRule DEFAULT_LOGFAR = new DefaultLogFilterAndRule(DEFAULT_FILTER_PREFIX,
            JSON.parseObject(DEFAULT_RULE).getString("separator"),
            JSON.parseObject(DEFAULT_RULE).getJSONObject("assignfields"), 0, 0);

    private static RuleFilterFactory factory = new RuleFilterFactory();
    ...
    public List<LogFilterAndRule> getAidLogFilterAndRuleList(String id) {
    ...
    public class LogFilterAndRuleBuilder {
        ...
        public LogFilterAndRule build(String classname) {
            ...
            LogFilterAndRule mainLogFAR = (LogFilterAndRule) ReflectHelper.newInstance(
                    ...
                    ConfigurationManager.getInstance().getFeatureClassLoader("collectclient"));
            ...
            AppLogPatternInfoCollection profileMap = dc.getLatestLogProfileDataMap();
    ...
    public FilterAndRuleChain createChain(ReliableTaildirEventReader reader) {

        return new FilterAndRuleChain(reader);
    }
    ...
    public class FilterAndRuleChain {
        ...
        public FilterAndRuleChain(ReliableTaildirEventReader reader) {
            this.reader = reader;
        }
