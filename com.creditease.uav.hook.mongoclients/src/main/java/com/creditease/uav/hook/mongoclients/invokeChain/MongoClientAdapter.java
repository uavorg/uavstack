...
package com.creditease.uav.hook.mongoclients.invokeChain;
...
public class MongoClientAdapter extends InvokeChainAdapter {
    ...
    public void beforePreCap(InvokeChainContext context, Object[] args) {
        ...
        context.put(InvokeChainConstants.CLIENT_IT_KEY,
                DataConvertHelper.toInt(System.getProperty("com.creditease.uav.invokechain.code.mongo.key"), 0));
        context.put(InvokeChainConstants.CLIENT_IT_CLASS,
                System.getProperty("com.creditease.uav.invokechain.code.mongo.class"));
    }
